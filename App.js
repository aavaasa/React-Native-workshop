          ...
          {data && (
            <View style={styles.infoView}>
              ...
              <View style={{display: 'flex', flexDirection: 'row!important'}}>
               ...
               <Text style={styles.whiteText}>Sunrise in: {getTime(data.sys.sunrise)} (Armenian time)</Text>
               <Text style={styles.whiteText}>Sunset in: {getTime(data.sys.sunset)} (Armenian time)</Text>
            </View>
          )}
      </ImageBackground>
    </View>
